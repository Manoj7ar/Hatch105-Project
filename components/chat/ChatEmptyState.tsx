  ...
  return (
    <div className="relative min-h-0 w-full flex-1">
      <div className="absolute inset-x-0 top-0 bottom-[8.5rem] flex flex-col items-center justify-center px-4">
        <p className="hatch-label mb-3">Dataset chat</p>
        ...
        <div className="flex max-w-2xl flex-wrap items-center justify-center gap-2">
          {CHAT_SUGGESTIONS.map((s) => (
            <button
              ...
              className="hatch-suggestion-pill px-4 py-2 text-sm text-[#0d0d0d] disabled:cursor-not-allowed disabled:opacity-50"
            >
              {s}
            </button>
          ))}
